...
fetchData(null, data => {
    ...
    document.title = `${title} - Recipedocious`;
    ...
    const /** {undefined || String} */ isSaved = window.localStorage.getItem(`recipedocious${recipeId}`);
    ...
    $detailContainer.innerHTML = `
        <figure class="detail-banner img-holder">
            <img src="${bannerUrl}" height="${height}" width="${width}" alt="${title}">
        </figure>
